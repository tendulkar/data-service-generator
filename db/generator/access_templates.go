...
func Args(filters []Filter) string {
	var args []string
...
func WhereClause(filters []Filter) string {
	result, _ := PrepareFilters(filters)
	return result
}

func PrepareWhereClause(filters []Filter) string {
	result, _ := PrepareFilters(filters)
	return result
}

func AttributeNames(updates []Update) string {
...
func AttributeValues(updates []Update) string {
	var values []string
	for i := range updates {
...
func SetClause(updates []Update) string {
	var clauses []string
...
func QueryArgs(request Request) string {
	var args []string
